...
8. Find the REDIRECT_URI constant and set its String value equal to the redirect URI you [registered in Azure Active Directory.](https://msdn.microsoft.com/library/azure/dn132599.aspx#BKMK_Adding)
