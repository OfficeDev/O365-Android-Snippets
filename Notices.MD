#Third Party Notices for Office 365 Code Snippets for Android
...
- Icons from the Action Bar Icon Pack are reproduced from work created and [shared by the Android Open Source Project](http://www.google.com/policies/), which are available here: http://developer.android.com/design/downloads/index.html and are used according to terms described in the Creative Commons 2.5 Attribution License. 
- Some icons were built from the [Action Bar and Tab Icon Generator](http://romannurik.github.io/AndroidAssetStudio/icons-actionbar.html#source.space.trim=1&source.space.pad=0&name=ic_action_example&theme=light&color=33b5e5%2C60) and are licensed under the under the [Creative Commons Attribution 3.0 Unported License](http://creativecommons.org/licenses/by/3.0/).
